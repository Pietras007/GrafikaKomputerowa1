...
{
    public static class EqualIcon
    {
        public static void PaintEqualIcon(this Graphics g, Edge edge, SolidBrush backgroundBrush, SolidBrush centreBrush, Font font)
        {
            ...
            g.FillRectangle(centreBrush, x + 3, y + 3, CONST.sizeRelationIcon - 6, CONST.sizeRelationIcon/2 - 4);
